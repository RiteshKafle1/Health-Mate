                        ...
                        <>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-3 py-2 text-text/60 hover:text-primary hover:bg-white/60 rounded-xl transition-all duration-200 border border-transparent hover:border-surface/30"
                                >
                                    <Search size={18} />
