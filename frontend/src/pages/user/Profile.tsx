...
import { useAuth } from '../../context/AuthContext';
import { getUserProfile, updateUserProfile } from '../../api/user';
import { uploadMyFile, getMyFile } from '../../api/user';
import type { User } from '../../types';
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="glass-card p-8">
                    ...
                    <div className="relative">
                        <div className="w-32 h-32 rounded-2xl overflow-hidden bg-dark-700">
                            {imagePreview || profile?.image ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-linear-to-br from-primary-500 to-secondary-500">
                        ...
                        {isEditing && (
                            <label className="absolute bottom-2 right-2 p-2 rounded-lg bg-primary-500 text-white cursor-pointer">
                                <Camera size={16} />
                                <input
                                    type="file"
                                    accept="image/*"
                ...
                {/* 🔹 REPORT UPLOAD SECTION (NEW) */}
                <div className="mb-8">
                    <label className="input-label">Medical / Report File</label>
                    ...
                    {reportUrl && (
                        <a
                            ...
                            className="flex items-center gap-2 text-primary-500 mb-3"
                        >
                            <FileText size={18} />
